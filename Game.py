...
class Game:
    def __init__(self):
        ...
        self.restart_text_rect=self.restart_text.get_rect(center=(300,630))
    ...
    def setuUpBgAndGround(self):
    #loading images and bg and ground
